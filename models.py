...
class FlowNet2C(FlowNetC.FlowNetC):
    ...
    def forward(self, inputs):
        ...
        print('x1', x1.size(), 'out_conv3a', out_conv3a.size(), 'out_conv_redir', out_conv_redir.size(), 'out_corr', out_corr.size(), 'in_conv3_1', in_conv3_1.size(), 'out_conv3_1', out_conv3_1.size(), sep = '\n')
